...
#   end
  ...
  it 'has a #to_h method' do
    value(Line.new).must_respond_to :to_h
  end

  describe '#to_h' do

    it 'returns a Hash' do
      value(Line.new.to_h).must_be_instance_of Hash
    end
    ...
    it 'passes :graphic_item_type through unchanged' do
  ...
  it 'has a #to_sexpr method' do
    value(Line.new).must_respond_to :to_sexpr
  end
